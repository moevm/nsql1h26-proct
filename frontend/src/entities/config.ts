...
export const entityConfigs: Record<string, EntityConfig> = {
  ...
  events: {
    ...
    columns: [
      ...
      { key: "ocr.frameIndex", label: "OCR кадр" },
      { key: "ocr.videoOffsetMs", label: "OCR смещение, мс" },
    ...
    filters: [
      ...
      numberFilters("ocr.frameIndex", "OCR кадр"),
      numberFilters("ocr.videoOffsetMs", "OCR смещение, мс"),
